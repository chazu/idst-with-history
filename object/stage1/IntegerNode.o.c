/* generated by Id 1.1 at ›h */
/* with the command: -I../boot/ -I../st80 -c IntegerNode.st -o ../stage1/IntegerNode.o.c */
...
static struct __slotinfo *IntegerNode___5fslots(oop _closure, oop v_self) { static struct __slotinfo info[]= { { "position", 0, 4 }, { "location", 4, 4 }, { "value", 8, 4 }, { "tag", 12, 4 }, { "constructor", 16, 4 }, { 0, 0, 0 } };  return &info[0]; }
static struct __methodinfo __info1= { "fromString:position:", "IntegerNode", "/Users/chazu/dev/c/idst-with-history/object/idc/IntegerNode.st", 0, 24, 36, 0 };
static oop IntegerNode__fromString_position_(oop v__closure, oop v_stateful_self, oop v_self, oop v_aString, oop v_aPosition)
 ...
 _l2:;
  ...
  _4= v_base;
  _line(33);
  _2=_sendv(s_readFrom_base_, 3, _2, _3, _4);
  _3= v_aPosition;
  _line(33);
...
static struct __methodinfo __info6= { "encode:", "IntegerNode", "/Users/chazu/dev/c/idst-with-history/object/idc/IntegerNode.st", 0, 36, 47, &__info1 };
...
static struct __methodinfo __info10= { "generate:", "IntegerNode", "/Users/chazu/dev/c/idst-with-history/object/idc/IntegerNode.st", 0, 47, 49, &__info6 };
...
static struct __methodinfo __info11= { "genInitialisation:", "IntegerNode", "/Users/chazu/dev/c/idst-with-history/object/idc/IntegerNode.st", 0, 49, 56, &__info10 };
static oop IntegerNode__genInitialisation_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
  ...
  if (!_1) goto _l7;
 {
  ...
  _line(52);
  _1=_sendv(s_initialiseInteger_constructor_with_, 4, _1, _2, _3, _4);
 }
  goto _l8;
 _l7:;
 {
  ...
  _4= ((struct t_IntegerNode *)v_stateful_self)->v_value;
  _line(53);
  _1=_sendv(s_initialiseLargeInteger_constructor_with_, 4, _1, _2, _3, _4);
 }
 _l8:;
  _1= v_self;
  _leave();
...
static struct __methodinfo __info12= { "println:", "IntegerNode", "/Users/chazu/dev/c/idst-with-history/object/idc/IntegerNode.st", 0, 56, 61, &__info11 };
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "IntegerNode.st", 0, 0, 0, &__info12 };
...
# define GC_add_roots _libid->gc_addRoots
  ...
  v_IntegerNode= _libid->proto2(v_LiteralNode, IntegerNode___5fsizeof(0, 0));
  ...
  _libid->method(v_IntegerNode, s__5fslots, (_imp_t)IntegerNode___5fslots);
  _libid->export("IntegerNode", v_IntegerNode);
  l_2= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 2, "0x");
  l_3= _sendv(s_value_5f_, 2, v_SmallInteger, 16);
  l_4= _sendv(s_value_5f_, 2, v_SmallInteger, 2);
  ...
  l_7= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 7, "integer");
  l_8= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 20, "largeNegativeInteger");
  l_9= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 20, "largePositiveInteger");
  ...
  l_13= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 8, "Integer(");
  l_14= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 1, ")");
