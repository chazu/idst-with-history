...
/* with the command: -I../boot/ -c tokenization.st -o ../stage1/tokenization.o.c */
...
static struct __methodinfo __info1= { "firstToken:", "SequenceableCollection", "/Users/chazu/dev/c/idst-with-history/object/st80/tokenization.st", 0, 25, 35, 0 };
...
static struct __methodinfo __info2= { "tokenized:", "SequenceableCollection", "/Users/chazu/dev/c/idst-with-history/object/st80/tokenization.st", 0, 35, 50, &__info1 };
...
static struct __methodinfo __info4= { "[] delimited:", "SequenceableCollection", "/Users/chazu/dev/c/idst-with-history/object/st80/tokenization.st", 0, 50, 61, &__info2 };
...
static struct __methodinfo __info3= { "delimited:", "SequenceableCollection", "/Users/chazu/dev/c/idst-with-history/object/st80/tokenization.st", 0, 50, 61, &__info4 };
static oop SequenceableCollection__delimited_(oop v__closure, oop v_stateful_self, oop v_self, oop v_delimiter)
 {
  ...
  /* Scope('delimiter'->ArgumentVariableNode 'self'->ArgumentVariableNode 'first'->TemporaryVariableNode 'out'->TemporaryVariableNode 'stateful_self'->ArgumentVariableNode) */
  /* nil */
  /* 2 */
  /* 1 */
...
static struct __methodinfo __info7= { "[] flattened", "SequenceableCollection", "/Users/chazu/dev/c/idst-with-history/object/st80/tokenization.st", 0, 61, 71, &__info3 };
...
static struct __methodinfo __info8= { "[] flattened", "SequenceableCollection", "/Users/chazu/dev/c/idst-with-history/object/st80/tokenization.st", 0, 61, 71, &__info7 };
...
static struct __methodinfo __info5= { "flattened", "SequenceableCollection", "/Users/chazu/dev/c/idst-with-history/object/st80/tokenization.st", 0, 61, 71, &__info8 };
static oop SequenceableCollection__flattened(oop v__closure, oop v_stateful_self, oop v_self)
 {
  ...
  _1= v_self;
  /* Scope('element'->ArgumentVariableNode) */
  /* Scope('self'->ArgumentVariableNode 'out'->TemporaryVariableNode 'len'->TemporaryVariableNode 'stateful_self'->ArgumentVariableNode) */
  /* nil */
  /* 2 */
  /* 1 */
