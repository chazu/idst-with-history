...
/* with the command: -I../boot/ -I../st80 -c AssignmentNode.st -o ../stage1/AssignmentNode.o.c */
...
static struct __slotinfo *AssignmentNode___5fslots(oop _closure, oop v_self) { static struct __slotinfo info[]= { { "position", 0, 4 }, { "location", 4, 4 }, { "value", 8, 4 }, { "variable", 12, 4 }, { 0, 0, 0 } };  return &info[0]; }
static struct __methodinfo __info1= { "withVariable:value:position:", "AssignmentNode", "/Users/chazu/dev/c/idst-with-history/object/idc/AssignmentNode.st", 0, 29, 36, 0 };
...
static struct __methodinfo __info2= { "encode:", "AssignmentNode", "/Users/chazu/dev/c/idst-with-history/object/idc/AssignmentNode.st", 0, 36, 42, &__info1 };
static oop AssignmentNode__encode_(oop v__closure, oop v_stateful_self, oop v_self, oop v_encoder)
 {
  ...
  _line(39);
  _1=_sendv(s_encodeLvalue_location_, 3, _1, _2, _3);
  _1= v_self;
  _leave();
  return _1;
  _leave();
 }
static struct __methodinfo __info3= { "generate:", "AssignmentNode", "/Users/chazu/dev/c/idst-with-history/object/idc/AssignmentNode.st", 0, 42, 48, &__info2 };
static oop AssignmentNode__generate_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  ...
  _2= v_gen;
  _line(45);
  _1=_sendv(s_generateStore_, 2, _1, _2);
  _1= v_self;
  _leave();
  return _1;
  _leave();
 }
static struct __methodinfo __info4= { "println:", "AssignmentNode", "/Users/chazu/dev/c/idst-with-history/object/idc/AssignmentNode.st", 0, 48, 55, &__info3 };
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "AssignmentNode.st", 0, 0, 0, &__info4 };
void __id__init__AssignmentNode(struct __libid *__libid)
{
  if (_libid) return;
...
# define GC_add_roots _libid->gc_addRoots
  ...
  v_AssignmentNode= _libid->proto2(v_ParseNode, AssignmentNode___5fsizeof(0, 0));
  _libid->method(v_AssignmentNode, s__5fsizeof, (_imp_t)AssignmentNode___5fsizeof);
  _libid->method(v_AssignmentNode, s__5fdebugName, (_imp_t)AssignmentNode___5fdebugName);
  _libid->method(v_AssignmentNode, s__5fslots, (_imp_t)AssignmentNode___5fslots);
  _libid->export("AssignmentNode", v_AssignmentNode);
  _libid->method(v_AssignmentNode, s_withVariable_value_position_, (_imp_t)AssignmentNode__withVariable_value_position_);
  _libid->method(v_AssignmentNode, s_encode_, (_imp_t)AssignmentNode__encode_);
  _libid->method(v_AssignmentNode, s_generate_, (_imp_t)AssignmentNode__generate_);
  l_5= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 2, ":=");
  l_6= _sendv(s_value_5f_, 2, v_SmallInteger, 1);
  _libid->method(v_AssignmentNode, s_println_, (_imp_t)AssignmentNode__println_);
  _leave();
}
