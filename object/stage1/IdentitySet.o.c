/* generated by Id 1.1 at ݒ */
/* with the command: -I../boot/ -c IdentitySet.st -o ../stage1/IdentitySet.o.c */
...
static oop IdentitySet__scanFor_(oop v__closure, oop v_stateful_self, oop v_self, oop v_anObject)
 {
  ...
  /* Scope('finish'->TemporaryVariableNode 'start'->TemporaryVariableNode 'tally'->SlotVariableNode 'array'->SlotVariableNode 'self'->ArgumentVariableNode 'stateful_self'->ArgumentVariableNode 'anObject'->ArgumentVariableNode) */
  /* nil */
  /* 2 */
  /* 1 */
