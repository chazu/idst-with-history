/* generated by Id 1.1 at ۣ */
/* with the command: -I../boot/ -I../st80 -c WordArrayNode.st -o ../stage1/WordArrayNode.o.c */
...
static struct __slotinfo *WordArrayNode___5fslots(oop _closure, oop v_self) { static struct __slotinfo info[]= { { "position", 0, 4 }, { "location", 4, 4 }, { "value", 8, 4 }, { "tag", 12, 4 }, { "constructor", 16, 4 }, { 0, 0, 0 } };  return &info[0]; }
static struct __methodinfo __info3= { "[] encode:", "WordArrayNode", "/Users/chazu/dev/c/idst-with-history/object/idc/WordArrayNode.st", 0, 26, 34, 0 };
static oop b_3(oop v__closure, oop v__self, oop v_word)
 {
  _enter(&__info3);
  oop _1= 0;
  _line(29);
...
static struct __methodinfo __info1= { "encode:", "WordArrayNode", "/Users/chazu/dev/c/idst-with-history/object/idc/WordArrayNode.st", 0, 26, 34, &__info3 };
...
static struct __methodinfo __info4= { "genDefinition:", "WordArrayNode", "/Users/chazu/dev/c/idst-with-history/object/idc/WordArrayNode.st", 0, 34, 40, &__info1 };
static oop WordArrayNode__genDefinition_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  ...
  _line(37);
  _1=_sendv(s_defineWordArray_withElements_, 3, _1, _2, _3);
  _1= v_self;
  _leave();
  return _1;
  _leave();
 }
static struct __methodinfo __info5= { "genInitialisation:", "WordArrayNode", "/Users/chazu/dev/c/idst-with-history/object/idc/WordArrayNode.st", 0, 40, 45, &__info4 };
static oop WordArrayNode__genInitialisation_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  ...
  _line(42);
  _1=_sendv(s_initialiseWordArray_constructor_with_, 4, _1, _2, _3, _4);
  _1= v_self;
  _leave();
  return _1;
  _leave();
 }
static struct __methodinfo __info8= { "[] println:", "WordArrayNode", "/Users/chazu/dev/c/idst-with-history/object/idc/WordArrayNode.st", 0, 45, 52, &__info5 };
...
static struct __methodinfo __info6= { "println:", "WordArrayNode", "/Users/chazu/dev/c/idst-with-history/object/idc/WordArrayNode.st", 0, 45, 52, &__info8 };
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "WordArrayNode.st", 0, 0, 0, &__info6 };
...
# define GC_add_roots _libid->gc_addRoots
  ...
  v_WordArrayNode= _libid->proto2(v_ArrayLiteralNode, WordArrayNode___5fsizeof(0, 0));
  ...
  _libid->method(v_WordArrayNode, s__5fslots, (_imp_t)WordArrayNode___5fslots);
  _libid->export("WordArrayNode", v_WordArrayNode);
  l_2= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 9, "wordArray");
  ...
  l_7= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 3, "#{ ");
  l_9= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 1, "}");
  l_10= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 1, " ");
  l_8= _sendv(s_function_5f_arity_5f_, 3, v_StaticBlockClosure, b_8, 1);
