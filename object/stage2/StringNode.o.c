...
/* with the command: -I../stage1/ -I../st80 -c StringNode.st -o ../stage2/StringNode.o.c */
...
static size_t StringNode___5fsizeof(oop _closure, oop v_self) { return sizeof(struct t_StringNode); }
static char *StringNode___5fdebugName(oop _closure, oop v_self) { return "StringNode"; }
static struct __slotinfo *StringNode___5fslots(oop _closure, oop v_self) { static struct __slotinfo info[]= { { "position", 0, 4 }, { "location", 4, 4 }, { "value", 8, 4 }, { "tag", 12, 4 }, { "constructor", 16, 4 }, { 0, 0, 0 } };  return &info[0]; }
static struct __methodinfo __info1= { "fromString:position:", "StringNode", "/Users/chazu/dev/c/idst-with-history/object/idc/StringNode.st", 0, 26, 31, 0 };
static oop StringNode__fromString_position_(oop v__closure, oop v_stateful_self, oop v_self, oop v_aString, oop v_aPosition)
 {
  _enter(&__info1);
  oop _1= 0;
  oop _2= 0;
...
static struct __methodinfo __info2= { "encode:", "StringNode", "/Users/chazu/dev/c/idst-with-history/object/idc/StringNode.st", 0, 31, 38, &__info1 };
static oop StringNode__encode_(oop v__closure, oop v_stateful_self, oop v_self, oop v_encoder)
 {
  _enter(&__info2);
  oop _1= 0;
  oop _2= 0;
  ...
  _1= v_encoder;
  _2= l_3;
  _3= ((struct t_StringNode *)v_stateful_self)->v_position;
  _line(33);
  _1=_sendv(s_requireType_at_, 3, _1, _2, _3);
  ((struct t_StringNode *)v_stateful_self)->v_constructor= _1;
  _1= v_encoder;
  _2= v_self;
  _line(34);
  _1=_sendv(s_encodeLiteral_, 2, _1, _2);
  ((struct t_StringNode *)v_stateful_self)->v_tag= _1;
  _1= v_encoder;
  _line(35);
  _1=_sendv(s_push, 1, _1);
  ((struct t_StringNode *)v_stateful_self)->v_location= _1;
  _1= v_self;
  _leave();
  return _1;
  _leave();
 }
static struct __methodinfo __info4= { "genInitialisation:", "StringNode", "/Users/chazu/dev/c/idst-with-history/object/idc/StringNode.st", 0, 38, 43, &__info2 };
static oop StringNode__genInitialisation_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  _enter(&__info4);
  oop _1= 0;
  oop _2= 0;
  ...
  _line(38);
  _1= v_gen;
  _2= ((struct t_StringNode *)v_stateful_self)->v_tag;
  _3= ((struct t_StringNode *)v_stateful_self)->v_constructor;
  _4= ((struct t_StringNode *)v_stateful_self)->v_value;
  _line(40);
...
static struct __methodinfo __info5= { "generate:", "StringNode", "/Users/chazu/dev/c/idst-with-history/object/idc/StringNode.st", 0, 43, 48, &__info4 };
static oop StringNode__generate_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  _enter(&__info5);
  oop _1= 0;
  oop _2= 0;
  ...
  _1= v_gen;
  _2= ((struct t_StringNode *)v_stateful_self)->v_tag;
  _3= ((struct t_StringNode *)v_stateful_self)->v_location;
  _line(45);
...
static struct __methodinfo __info6= { "println:", "StringNode", "/Users/chazu/dev/c/idst-with-history/object/idc/StringNode.st", 0, 48, 53, &__info5 };
static oop StringNode__println_(oop v__closure, oop v_stateful_self, oop v_self, oop v_indent)
 {
  _enter(&__info6);
  oop _1= 0;
  oop _2= 0;
  ...
  _1= ((struct t_StringNode *)v_stateful_self)->v_value;
  _line(51);
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "StringNode.st", 0, 0, 0, &__info6 };
void __id__init__StringNode(struct __libid *__libid)
{
  if (_libid) return;
...
# define GC_add_roots _libid->gc_addRoots
  ...
  v_StringNode= _libid->proto2(v_LiteralNode, StringNode___5fsizeof(0, 0));
  _libid->method(v_StringNode, s__5fsizeof, (_imp_t)StringNode___5fsizeof);
  _libid->method(v_StringNode, s__5fdebugName, (_imp_t)StringNode___5fdebugName);
  _libid->method(v_StringNode, s__5fslots, (_imp_t)StringNode___5fslots);
  _libid->export("StringNode", v_StringNode);
  _libid->method(v_StringNode, s_fromString_position_, (_imp_t)StringNode__fromString_position_);
  l_3= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 6, "string");
  _libid->method(v_StringNode, s_encode_, (_imp_t)StringNode__encode_);
  _libid->method(v_StringNode, s_genInitialisation_, (_imp_t)StringNode__genInitialisation_);
  _libid->method(v_StringNode, s_generate_, (_imp_t)StringNode__generate_);
  l_7= _sendv(s_value_5f_, 2, v_Character, 39);
  l_8= _sendv(s_value_5f_, 2, v_Character, 10);
  _libid->method(v_StringNode, s_println_, (_imp_t)StringNode__println_);
  _leave();
}
