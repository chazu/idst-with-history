/* generated by Id 1.1 at èÚð */
/* with the command: -I../stage1/ -I../st80 -c PrimitiveNode.st -o ../stage2/PrimitiveNode.o.c */
...
static size_t PrimitiveNode___5fsizeof(oop _closure, oop v_self) { return sizeof(struct t_PrimitiveNode); }
static char *PrimitiveNode___5fdebugName(oop _closure, oop v_self) { return "PrimitiveNode"; }
static struct __slotinfo *PrimitiveNode___5fslots(oop _closure, oop v_self) { static struct __slotinfo info[]= { { "position", 0, 4 }, { "location", 4, 4 }, { "code", 8, 4 }, { "mtype", 12, 4 }, { 0, 0, 0 } };  return &info[0]; }
static struct __methodinfo __info1= { "withCode:position:", "PrimitiveNode", "/Users/chazu/dev/c/idst-with-history/object/idc/PrimitiveNode.st", 0, 27, 34, 0 };
static oop PrimitiveNode__withCode_position_(oop v__closure, oop v_stateful_self, oop v_self, oop v_codeString, oop v_aPosition)
 {
  _enter(&__info1);
  oop _1= 0;
  oop _2= 0;
  ...
  v_stateful_self= _1;
  _1= v_codeString;
  ((struct t_PrimitiveNode *)v_stateful_self)->v_code= _1;
  _1= v_nil;
  ((struct t_PrimitiveNode *)v_stateful_self)->v_mtype= _1;
  _1= v_self;
  _leave();
  return _1;
  _leave();
 }
static struct __methodinfo __info2= { "println:", "PrimitiveNode", "/Users/chazu/dev/c/idst-with-history/object/idc/PrimitiveNode.st", 0, 34, 43, &__info1 };
static oop PrimitiveNode__println_(oop v__closure, oop v_stateful_self, oop v_self, oop v_indent)
 {
  _enter(&__info2);
  oop _1= 0;
  oop _2= 0;
  ...
  _1= ((struct t_PrimitiveNode *)v_stateful_self)->v_code;
  _line(38);
  _1=_sendv(s_print, 1, _1);
  _1= v_self;
  _2= v_indent;
...
static struct __methodinfo __info5= { "encode:", "PrimitiveNode", "/Users/chazu/dev/c/idst-with-history/object/idc/PrimitiveNode.st", 0, 43, 50, &__info2 };
static oop PrimitiveNode__encode_(oop v__closure, oop v_stateful_self, oop v_self, oop v_encoder)
 {
  _enter(&__info5);
  oop _1= 0;
  _line(43);
  _1= v_encoder;
  _line(45);
  _1=_sendv(s_methodType, 1, _1);
  ((struct t_PrimitiveNode *)v_stateful_self)->v_mtype= _1;
  _1= v_encoder;
  _line(47);
  _1=_sendv(s_push, 1, _1);
  ((struct t_PrimitiveNode *)v_stateful_self)->v_location= _1;
  _1= v_self;
  _leave();
  return _1;
  _leave();
 }
static struct __methodinfo __info6= { "generate:", "PrimitiveNode", "/Users/chazu/dev/c/idst-with-history/object/idc/PrimitiveNode.st", 0, 50, 55, &__info5 };
static oop PrimitiveNode__generate_(oop v__closure, oop v_stateful_self, oop v_self, oop v_gen)
 {
  _enter(&__info6);
  oop _1= 0;
  oop _2= 0;
  ...
  _line(50);
  _1= v_gen;
  _2= ((struct t_PrimitiveNode *)v_stateful_self)->v_code;
  _3= ((struct t_PrimitiveNode *)v_stateful_self)->v_mtype;
  _line(52);
  _1=_sendv(s_genPrimitive_in_, 3, _1, _2, _3);
  _1= v_gen;
  _2= ((struct t_PrimitiveNode *)v_stateful_self)->v_location;
  _line(53);
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "PrimitiveNode.st", 0, 0, 0, &__info6 };
void __id__init__PrimitiveNode(struct __libid *__libid)
{
  if (_libid) return;
...
# define GC_add_roots _libid->gc_addRoots
  ...
  v_PrimitiveNode= _libid->proto2(v_ParseNode, PrimitiveNode___5fsizeof(0, 0));
  _libid->method(v_PrimitiveNode, s__5fsizeof, (_imp_t)PrimitiveNode___5fsizeof);
  _libid->method(v_PrimitiveNode, s__5fdebugName, (_imp_t)PrimitiveNode___5fdebugName);
  _libid->method(v_PrimitiveNode, s__5fslots, (_imp_t)PrimitiveNode___5fslots);
  _libid->export("PrimitiveNode", v_PrimitiveNode);
  _libid->method(v_PrimitiveNode, s_withCode_position_, (_imp_t)PrimitiveNode__withCode_position_);
  l_3= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 12, "Primitive { ");
  l_4= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 1, "}");
  _libid->method(v_PrimitiveNode, s_println_, (_imp_t)PrimitiveNode__println_);
  _libid->method(v_PrimitiveNode, s_encode_, (_imp_t)PrimitiveNode__encode_);
  _libid->method(v_PrimitiveNode, s_generate_, (_imp_t)PrimitiveNode__generate_);
  _leave();
}
