...
static struct __methodinfo __info1= { "initialize", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 44, 62, 0 };
...
static struct __methodinfo __info3= { "withOuter:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 62, 70, &__info1 };
...
static struct __methodinfo __info5= { "newScope", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 70, 72, &__info3 };
...
static struct __methodinfo __info6= { "stackSize:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 72, 73, &__info5 };
...
static struct __methodinfo __info7= { "stackSize", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 73, 75, &__info6 };
...
static struct __methodinfo __info8= { "addBlock:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 75, 76, &__info7 };
...
static struct __methodinfo __info9= { "blocks", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 76, 78, &__info8 };
...
static struct __methodinfo __info10= { "outer", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 78, 79, &__info9 };
...
static struct __methodinfo __info11= { "tag", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 79, 81, &__info10 };
...
static struct __methodinfo __info12= { "increaseLevel", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 81, 82, &__info11 };
...
static struct __methodinfo __info14= { "level", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 82, 83, &__info12 };
...
static struct __methodinfo __info15= { "nextOffset", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 83, 85, &__info14 };
...
static struct __methodinfo __info17= { "exportState", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 85, 86, &__info15 };
...
static struct __methodinfo __info18= { "hasExports", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 86, 88, &__info17 };
...
static struct __methodinfo __info19= { "importState", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 88, 89, &__info18 };
...
static struct __methodinfo __info20= { "hasImports", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 89, 91, &__info19 };
...
static struct __methodinfo __info21= { "needsOuterScope", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 91, 93, &__info20 };
...
static struct __methodinfo __info22= { "hasNLR", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 93, 95, &__info21 };
...
static struct __methodinfo __info23= { "noteNLR", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 95, 102, &__info22 };
...
static struct __methodinfo __info24= { "hasVarargs:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 102, 103, &__info23 };
...
static struct __methodinfo __info25= { "hasVarargs", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 103, 105, &__info24 };
...
static struct __methodinfo __info28= { "[] stateVectorSize", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 105, 113, &__info25 };
...
static struct __methodinfo __info26= { "stateVectorSize", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 105, 113, &__info28 };
static oop Scope__stateVectorSize(oop v__closure, oop v_stateful_self, oop v_self)
 {
  ...
  /* Scope('tag'->SlotVariableNode 'exportFlag'->SlotVariableNode 'importFlag'->SlotVariableNode 'nlrFlag'->SlotVariableNode 'argumentCount'->SlotVariableNode 'temporaryCount'->SlotVariableNode 'stateful_self'->ArgumentVariableNode 'hasVarargs'->SlotVariableNode 'size'->TemporaryVariableNode 'stackSize'->SlotVariableNode 'blocks'->SlotVariableNode 'outer'->SlotVariableNode 'encodings'->SlotVariableNode 'tally'->SlotVariableNode 'array'->SlotVariableNode 'self'->ArgumentVariableNode 'lastOffset'->SlotVariableNode 'level'->SlotVariableNode) */
  /* nil */
  /* 2 */
  /* 1 */
...
static struct __methodinfo __info31= { "[] encode:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 113, 126, &__info26 };
...
static struct __methodinfo __info30= { "encode:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 113, 126, &__info31 };
...
static struct __methodinfo __info33= { "[] encode:from:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 126, 138, &__info30 };
static oop b_33(oop v__closure, oop v__self)
 {
  ...
  /* ifFalse: */
  _1= 0;
  _2= ((struct t_Scope *)((oop *)((struct t_BlockClosure *)((struct t_BlockClosure *)v__self)->v_state))[2])->v_outer;  /* outer */
  _line(130);
  _2=_sendv(s_isNil, 1, _2);
  if (_2) goto _l7;
 {
  _1= ((struct t_Scope *)((oop *)((struct t_BlockClosure *)((struct t_BlockClosure *)v__self)->v_state))[2])->v_outer;  /* outer */
  _2= ((oop *)((struct t_BlockClosure *)((struct t_BlockClosure *)v__self)->v_state))[3];  /* nameString */
  _3= ((oop *)((struct t_BlockClosure *)((struct t_BlockClosure *)v__self)->v_state))[4];  /* innerScope */
  _line(130);
...
static struct __methodinfo __info32= { "encode:from:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 126, 138, &__info33 };
static oop Scope__encode_from_(oop v__closure, oop v_stateful_self, oop v_self, oop v_nameString, oop v_innerScope)
 {
  ...
  ((oop *)_state1)[3]= v_nameString;
  ((oop *)_state1)[4]= v_innerScope;
  _nlr= (oop)&__nlr;
  if (setjmp(__nlr)) { return _libid->nlresult(); }
  _line(126);
  _1= ((oop *)_state1)[1];  /* self */
  _2= ((oop *)_state1)[3];  /* nameString */
  /* Scope() */
  /* Scope('tag'->SlotVariableNode 'exportFlag'->SlotVariableNode 'nameString'->ArgumentVariableNode 'importFlag'->SlotVariableNode 'stateful_self'->ArgumentVariableNode 'argumentCount'->SlotVariableNode 'temporaryCount'->SlotVariableNode 'var'->TemporaryVariableNode 'stackSize'->SlotVariableNode 'nlrFlag'->SlotVariableNode 'hasVarargs'->SlotVariableNode 'blocks'->SlotVariableNode 'outer'->SlotVariableNode 'encodings'->SlotVariableNode 'innerScope'->ArgumentVariableNode 'tally'->SlotVariableNode 'array'->SlotVariableNode 'self'->ArgumentVariableNode 'lastOffset'->SlotVariableNode 'level'->SlotVariableNode) */
  /* nil */
  /* 2 */
  /* 1 */
  ...
  if (_2) goto _l9;
 {
  _2= ((struct t_Scope *)((oop *)_state1)[2])->v_level;  /* level */
  _3= ((oop *)_state1)[4];  /* innerScope */
  _line(133);
...
static struct __methodinfo __info34= { "closeOver:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 138, 147, &__info32 };
...
static struct __methodinfo __info35= { "declare:as:position:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 147, 152, &__info34 };
...
static struct __methodinfo __info36= { "declareSlot:position:type:receiver:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 152, 159, &__info35 };
...
static struct __methodinfo __info37= { "declareArgument:position:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 159, 166, &__info36 };
...
static struct __methodinfo __info39= { "declareTemporary:position:", "Scope", "/Users/chazu/dev/c/idst-with-history/object/idc/Scope.st", 0, 166, 172, &__info37 };
