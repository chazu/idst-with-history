...
/* with the command: -I../../stage2/ -I../../st80 -g -m echo.st -o echo.c */
...
static struct __methodinfo __info1= { "[] ?", "?", "/Users/chazu/dev/c/idst-with-history/object/examples/echo/echo.st", 0, 0, 0, 0 };
...
static struct __methodinfo __info2= { "[] ?", "?", "/Users/chazu/dev/c/idst-with-history/object/examples/echo/echo.st", 0, 0, 0, &__info1 };
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "echo.st", 0, 0, 0, &__info2 };
void __id__init__(struct __libid *__libid)
{
  ...
  l_3= _sendv(s_value_5f_, 2, v_Character, 10);
  l_4= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 1, " ");
  l_1= _sendv(s_function_5f_arity_5f_, 3, v_StaticBlockClosure, b_1, 1);
  l_2= _sendv(s_function_5f_arity_5f_, 3, v_StaticBlockClosure, b_2, 0);
 {
  oop v_argv= 0;
  oop _1= 0;
  oop _2= 0;
