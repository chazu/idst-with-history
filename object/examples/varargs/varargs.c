...
/* with the command: -I../../stage2/ -I../../st80 -g -m varargs.st -o varargs.c */
...
static struct __methodinfo __info1= { "foo:", "Object", "/Users/chazu/dev/c/idst-with-history/object/examples/varargs/varargs.st", 0, 3, 10, 0 };
static oop Object__foo_(oop v__closure, oop v_stateful_self, oop v_self, oop v_a, ...)
 {
  _enter(&__info1);
  oop _1= 0;
  va_list ap;
...
static struct __methodinfo __info5= { "sum", "Object", "/Users/chazu/dev/c/idst-with-history/object/examples/varargs/varargs.st", 0, 15, 23, &__info1 };
static oop Object__sum(oop v__closure, oop v_stateful_self, oop v_self, ...)
 {
  _enter(&__info5);
  oop v_sum= 0;
  oop v_next= 0;
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "varargs.st", 0, 0, 0, &__info5 };
void __id__init__(struct __libid *__libid)
{
  ...
  l_2= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 11, "Object.foo:");
  _libid->method(v_Object, s_foo_, (_imp_t)Object__foo_);
  l_3= _sendv(s_value_5f_, 2, v_SmallInteger, 42);
  l_4= _sendv(s_value_5f_, 2, v_SmallInteger, 666);
 {
  oop _1= 0;
  oop _2= 0;
  oop _3= 0;
  ...
  _3= l_4;
  _line(11);
  _1=_sendv(s_foo_, 3, _1, _2, _3);
 }
  l_6= _sendv(s_value_5f_, 2, v_SmallInteger, 0);
  _libid->method(v_Object, s_sum, (_imp_t)Object__sum);
  l_7= _sendv(s_value_5f_, 2, v_SmallInteger, 1);
  l_8= _sendv(s_value_5f_, 2, v_SmallInteger, 2);
  ...
  l_10= _sendv(s_value_5f_, 2, v_SmallInteger, 4);
 {
  ...
  _6= v_nil;
  _line(24);
  _1=_sendv(s_sum, 6, _1, _2, _3, _4, _5, _6);
  _line(24);
  _1=_sendv(s_println, 1, _1);
 }
  _leave();
