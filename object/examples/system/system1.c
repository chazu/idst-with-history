/* generated by Id 1.1 at èÚû */
/* with the command: -I../../stage2/ -I../../st80 -g -m system1.st -o system1.c */
...
static struct __methodinfo __info1= { "system:", "Object", "/Users/chazu/dev/c/idst-with-history/object/examples/system/system1.st", 0, 3, 8, 0 };
static oop Object__system_(oop v__closure, oop v_stateful_self, oop v_self, oop v_aString)
 {
  _enter(&__info1);
  oop _1= 0;
  oop _2= 0;
  ...
  _line(5);
  _2=_sendv(s__5fsystem_5f_, 2, _2, _3);
  _line(5);
...
static struct __methodinfo __info2= { "_system_:", "Object", "/Users/chazu/dev/c/idst-with-history/object/examples/system/system1.st", 0, 8, 13, &__info1 };
static oop Object___5fsystem_5f_(oop v__closure, oop v_stateful_self, oop v_self, oop v__aString)
 {
  _enter(&__info2);
  oop _1= 0;
  _line(8);
...
static struct __methodinfo __info3= { "[] ?", "?", "/Users/chazu/dev/c/idst-with-history/object/examples/system/system1.st", 0, 0, 0, &__info2 };
static oop b_3(oop v__closure, oop v__self, oop v_arg)
 {
  _enter(&__info3);
  oop _1= 0;
  oop _2= 0;
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "system1.st", 0, 0, 0, &__info3 };
void __id__init__(struct __libid *__libid)
{
  ...
  _libid->method(v_Object, s_system_, (_imp_t)Object__system_);
  _libid->method(v_Object, s__5fsystem_5f_, (_imp_t)Object___5fsystem_5f_);
  l_4= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 4, " => ");
