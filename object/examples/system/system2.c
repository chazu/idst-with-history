...
/* with the command: -I../../stage2/ -I../../st80 -g -m system2.st -o system2.c */
...
static struct __methodinfo __info1= { "system", "String", "/Users/chazu/dev/c/idst-with-history/object/examples/system/system2.st", 0, 3, 8, 0 };
static oop String__system(oop v__closure, oop v_stateful_self, oop v_self)
 {
  _enter(&__info1);
  oop _1= 0;
  oop _2= 0;
...
static struct __methodinfo __info2= { "_system", "String", "/Users/chazu/dev/c/idst-with-history/object/examples/system/system2.st", 0, 8, 13, &__info1 };
static oop String___5fsystem(oop v__closure, oop v_stateful_self, oop v_self)
 {
  _enter(&__info2);
  oop _1= 0;
  _line(8);
...
static struct __methodinfo __info3= { "[] ?", "?", "/Users/chazu/dev/c/idst-with-history/object/examples/system/system2.st", 0, 0, 0, &__info2 };
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "system2.st", 0, 0, 0, &__info3 };
void __id__init__(struct __libid *__libid)
{
  ...
  _libid->method(v_String, s_system, (_imp_t)String__system);
  _libid->method(v_String, s__5fsystem, (_imp_t)String___5fsystem);
