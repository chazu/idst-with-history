...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "main.st", 0, 0, 0, 0 };
void __id__init__(struct __libid *__libid)
{
  ...
  l_1= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 12, "this is main");
 {
  oop _1= 0;
  _1= l_1;
  _line(3);
  ...
  _sendv(s__5fimport_, 3, _libid->_object, "lib1", "__id__init__lib1");
  _sendv(s__5fimport_, 3, _libid->_object, "lib2", "__id__init__lib2");
  l_2= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 9, "all done!");
 {
  oop _1= 0;
  _1= l_2;
  _line(8);
