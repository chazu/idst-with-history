/* generated by Id 1.1 at èB */
/* with the command: -I../../stage2/ -I../../st80 -g -c lib1.st -o lib1.o.c */
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "lib1.st", 0, 0, 0, 0 };
void __id__init__lib1(struct __libid *__libid)
{
  if (_libid) return;
...
# define GC_add_roots _libid->gc_addRoots
  ...
  l_1= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 20, "lib1 initialising...");
 {
  oop _1= 0;
  _1= l_1;
  _line(3);
