/* generated by Id 1.1 at ËZÌ */
/* with the command: -I../../stage2/ -I../../st80 -g -m typename.st -o typename.c */
...
static struct __methodinfo __info1= { "asPrototype", "String", "/Users/chazu/dev/c/idst-with-history/object/examples/typename/typename.st", 0, 3, 8, 0 };
static oop String__asPrototype(oop v__closure, oop v_stateful_self, oop v_self)
 {
  _enter(&__info1);
  oop _1= 0;
  _line(3);
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "typename.st", 0, 0, 0, &__info1 };
void __id__init__(struct __libid *__libid)
{
  ...
  _libid->method(v_String, s_asPrototype, (_imp_t)String__asPrototype);
  l_2= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 6, "Number");
 {
  oop _1= 0;
  _1= l_2;
  _line(9);
  _1=_sendv(s_asPrototype, 1, _1);
  _line(9);
