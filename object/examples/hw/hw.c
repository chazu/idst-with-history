/* generated by Id 1.1 at 蚺 */
/* with the command: -I../../stage2/ -I../../st80 -g -m hw.st -o hw.c */
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "hw.st", 0, 0, 0, 0 };
void __id__init__(struct __libid *__libid)
{
  ...
  l_1= _sendv(s_size_5f_value_5f_, 3, v_ImmutableString, 12, "Hello, world");
 {
  oop _1= 0;
  _1= l_1;
  _line(4);
