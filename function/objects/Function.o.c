/* generated by Id 1.1 at 蚵 */
/* with the command: -I../../object/stage2/ -I. -g -g -c Function.st -o Function.o.c */
...
static struct __methodinfo __info1= { "isFunction", "Object", "/Users/chazu/dev/c/idst-with-history/function/objects/Function.st", 0, 3, 4, 0 };
static oop Object__isFunction(oop v__closure, oop v_stateful_self, oop v_self)
 {
  _enter(&__info1);
  oop _1= 0;
  _line(3);
...
static struct __methodinfo __info2= { "isFunction", "Function", "/Users/chazu/dev/c/idst-with-history/function/objects/Function.st", 0, 4, 5, &__info1 };
static oop Function__isFunction(oop v__closure, oop v_stateful_self, oop v_self)
 {
  _enter(&__info2);
  oop _1= 0;
  _line(4);
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "Function.st", 0, 0, 0, &__info2 };
void __id__init__Function(struct __libid *__libid)
{
  if (_libid) return;
...
# define GC_add_roots _libid->gc_addRoots
  ...
  v_Function= _libid->import("Function");
  v_true= _libid->import("true");
  v_false= _libid->import("false");
  _libid->method(v_Object, s_isFunction, (_imp_t)Object__isFunction);
  _libid->method(v_Function, s_isFunction, (_imp_t)Function__isFunction);
  _leave();
}
