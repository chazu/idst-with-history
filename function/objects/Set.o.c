...
/* with the command: -I../../object/stage2/ -I. -g -g -c Set.st -o Set.o.c */
...
static struct __methodinfo __info1= { "hashOf:", "Set", "/Users/chazu/dev/c/idst-with-history/function/objects/Set.st", 0, 5, 6, 0 };
static oop Set__hashOf_(oop v__closure, oop v_stateful_self, oop v_self, oop v_anObject)
 {
  _enter(&__info1);
  oop _1= 0;
  _line(5);
...
static struct __methodinfo __info2= { "compare:with:", "Set", "/Users/chazu/dev/c/idst-with-history/function/objects/Set.st", 0, 6, 7, &__info1 };
static oop Set__compare_with_(oop v__closure, oop v_stateful_self, oop v_self, oop v_anEntry, oop v_anObject)
 {
  _enter(&__info2);
  oop _1= 0;
  oop _2= 0;
...
static struct __methodinfo __info= { "__id__init__", "<initialisation>", "Set.st", 0, 0, 0, &__info2 };
...
# define GC_add_roots _libid->gc_addRoots
  ...
  _libid->method(v_Set, s_hashOf_, (_imp_t)Set__hashOf_);
  _libid->method(v_Set, s_compare_with_, (_imp_t)Set__compare_with_);
  _leave();
}
